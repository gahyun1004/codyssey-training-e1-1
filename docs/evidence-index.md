...
실제 수행이 끝난 뒤 상태를 `완료`로 변경합니다. 빈 템플릿이나 `.gitkeep`은 수행 증거가 아닙니다.
...
| Docker 운영 | 공통 | [docker-operations.md](docker-operations.md) | `logs/docker-basic.txt` | `screenshots/docker/` | 미완료 |
...
| GitHub | 공통 | [environment.md](environment.md) | `logs/environment.txt` | `screenshots/github/` | 미완료 |
| 최종 검증 | 공통 | [test-results.md](test-results.md) | 실제 검증 결과 | `screenshots/github/` | 미완료 |
